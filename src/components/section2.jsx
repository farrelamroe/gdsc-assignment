        ...
        <>
            <div className=" h-full bg-white">
                <div className=" block text-left pt-20 sm:pl-20 mobile:mx-5">
                    <p className="font-bold text-4xl " data-aos="zoom-in"
						data-aos-duration="1000"
						data-aos-delay="200">Kenapa GoRide?</p>
                    ...
                    <div className="flex flex-row justify-between gap-x-1 top-20 sm:pb-20 mobile:flex-col-reverse" data-aos="fade-left"
						data-aos-duration="1000"
						data-aos-delay="200">
                    ...
                    <div className="flex flex-row justify-between gap-x-1 top-20 pb-20 mobile:flex-col-reverse" data-aos="fade-left"
						data-aos-duration="1000"
						data-aos-delay="200">
                        <div className="flex flex-col justify-center gap-y-12 sm:pr-0 lg:pr-20 mobile:pr-0">
