        ...
        <div className="container-fluid bg-white">
            <div className="block text-left sm:pt-20 sm:pl-20 mobile:mx-5 bg-white">
                <div className="flex sm:flex-row justify-between gap-x-16 pt-20 relative pb-20 mobile:flex-col mobile:py-5 sm:items-center sm:pt-5">
                   <img src={section5_1} alt="section5_1" className="lg:w-[600px] rounded-[50px] mobile:rounded-lg sm:w-[300px]"data-aos="fade-right"
						data-aos-duration="1000"
						data-aos-delay="200"/>
                    <div className="flex flex-col justify-center gap-y-12 pr-20 mobile:pr-0 mobile:pt-5"data-aos="fade-left"
						data-aos-duration="1000"
						data-aos-delay="200">
            ...
            <div className="bg-auto h-[494px] sm:mx-20 sm:rounded-[50px] sm:bg-bgdekstop5 mobile:bg-bgmobile5  mobile:bg-cover bottom-20 mt-20 relative" data-aos="zoom-in-up"
						data-aos-duration="1000"
						data-aos-delay="200">
